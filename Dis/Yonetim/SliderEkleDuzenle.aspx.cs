...
{
    public partial class SliderEkleDuzenle : System.Web.UI.Page
    {
        ...
        protected void Button3_Click(object sender, EventArgs e)
        {
            ...
            baglanti.Open();
            SqlCommand komut = new SqlCommand("insert into Slider2(Resim1,Resim2) values (@Resim1,@Resim2)", baglanti);
            ...
            baglanti.Close();
            Response.Redirect("SliderEkleDuzenle.aspx");
        }
        ...
        protected void Button2_Click1(object sender, EventArgs e)
        {
            if (FileUpload1.HasFile)
            {
                ...
                lblResim.Text = "lütfen bir resim seç";
        }
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            if (FileUpload2.HasFile)
            {
                if (FileUpload2.PostedFile.ContentType == "image/jpg" || FileUpload2.PostedFile.ContentType == "image/png" || FileUpload2.PostedFile.ContentType == "image/jpeg")
                {
                    ...
                    lblResim2.Text = ResimAd.ToString();
                }
                else
                {
